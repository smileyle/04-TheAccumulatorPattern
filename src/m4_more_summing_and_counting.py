...
def run_test_sum_unit_fractions_from():
    ...
    # ------------------------------------------------------------------
    expect2 = 1.09563
    answer2 = sum_unit_fractions_from(4, 10)
    print('Test 2 expected:', expect2, '(approximately)')
    print('       actual:  ', answer2)
    expect3 = 0.652106782
    answer3 = sum_unit_fractions_from(7, 12)
    print('Test 3 expected:', expect3, '(approximately)')
    print('       actual:  ', answer3)
