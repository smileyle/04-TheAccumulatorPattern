...
def run_test_sum_more_cosines():
    ...
    # ------------------------------------------------------------------
    expect = -1.5194806
    answer1 = sum_more_cosines(1, 4)
    print('Test 2 expected:', expect, '(approximately)')
    print('       actual:  ', answer1)
    expect2 = -0.0620482276
    answer2 = sum_more_cosines(2, 7)
    print('Test 3 expected:', expect2, '(approximately)')
